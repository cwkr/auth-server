...
type Store interface {
	...
	SaveSession(r *http.Request, w http.ResponseWriter, authTime time.Time, userID, sessionName string, otp bool) error
	VerifySession(r *http.Request, w http.ResponseWriter, userID, sessionName string) error
